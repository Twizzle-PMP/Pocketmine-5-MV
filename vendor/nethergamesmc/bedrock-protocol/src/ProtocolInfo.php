...
final class ProtocolInfo{
	...
	public const MINECRAFT_VERSION = 'v1.26.20';
	...
	public const DEBUG_DRAWER_PACKET = 0x148; // pre-1.26.20 compat alias
	...
	public const CLIENTBOUND_DATA_DRIVEN_UI_CLOSE_ALL_SCREENS_PACKET = 0x14e; // pre-1.26.20 compat alias

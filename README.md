...
Latest update includes:
- **Protocol 975** â€” Registered with full multiversion backward compatibility
- **Updated packet compatibility** â€” Core packet calls were adapted to the latest BedrockProtocol signatures used by `1.26.20`
- **Modern furnace recipe handling** â€” `1.26.20` clients receive furnace recipes in the format expected by the new protocol while older versions keep legacy behavior
